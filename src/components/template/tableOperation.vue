      ...
      >
        ...
        <el-form-item>
          ...
          <el-button
            type="primary"
            plain
            @click="handlePopup(operationStatus.add, null)"
            >新增</el-button
          >
        </el-form-item>
      </el-form>
        ...
        <el-table-column label="操作" fixed="right" width="100">
          <template #default="scope">
            <el-button
              text
              type="primary"
              @click="handlePopup(operationStatus.edit, scope.row)"
              >编辑</el-button
            >
            <br />
            ...
            <br />
            <el-button text type="danger" @click="removeDataById(scope.row.id)"
              >删除</el-button
            >
          </template>
        </el-table-column>
    ...
    >
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="基本介绍：" prop="introduction">
              <el-input
                v-model="newlyForm.introduction"
                type="textarea"
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button type="primary" @click="onSubmit(operationFormRef)"
            >确 定</el-button
          >
        </span>
      </template>
