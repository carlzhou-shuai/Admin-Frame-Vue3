        ...
        <el-col :xs="24" :sm="10" :md="10" :lg="10" :xl="10">
          <div class="image-space">
            <strong class="workbench-nav-title"
              >{{ hoursTip }}，欢迎使用{{ siteName }}，祝你开开心心每一天
              !</strong
            >
            <small class="workbench-nav-introduce"
              >轻松创建、部署您的中后台系统、提升研发效率、降低业务成本。</small
            >
          </div>
        </el-col>
      </el-row>
    ...
    <el-row :gutter="8">
      <el-col :xs="24" :sm="18">
        ...
        >
          <template #header>
            <div class="card-header">
              <i class="fa fa-th-large module-icon" aria-hidden="true"></i>
              项目统计
            </div>
          </template>
        ...
        >
          <template #header>
            <div class="card-header">
              <i
                class="fa fa-check-square-o module-icon"
                aria-hidden="true"
              ></i>
              待办事项
            </div>
      ...
      <el-col :xs="24" :sm="6">
        ...
        >
          <template #header>
            <div class="card-header">
              <i class="fa fa-bars module-icon" aria-hidden="true"></i>快速导航
              / 最近使用
            </div>
          </template>
        ...
        <el-card
          class="box-card m-t8"
          shadow="never"
          :body-style="{ padding: '20px 20px 35px 20px' }"
        >
          <template #header>
            <div class="card-header">
              <i
                class="fa fa-question-circle module-icon"
                aria-hidden="true"
              ></i
              >使用帮助
            </div>
          ...
          <div class="workbench-use-help">
            <ul>
              <li v-for="item in useHelpData" :key="item.url">
                <el-link type="info" @click="toViewDocument(item.url)">{{
                  item.name
                }}</el-link>
              </li>
            </ul>
