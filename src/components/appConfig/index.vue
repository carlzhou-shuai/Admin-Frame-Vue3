        ...
        <ul class="config-list">
          ...
          <li>
            ...
            <el-switch
              size="default"
              inactive-color="#A8ABB2"
              v-model="configStore.isGrayscale"
              inline-prompt
              active-text="开"
              inactive-text="关"
            />
        ...
        <ul class="config-list">
          <li>
            ...
            <el-switch
              ...
              inactive-color="#A8ABB2"
              v-model="configStore.appConfig.showBreadcrumb"
              inline-prompt
              active-text="开"
              inactive-text="关"
            />
          ...
          <li>
            ...
            <el-switch
              ...
              inactive-color="#A8ABB2"
              v-model="configStore.appConfig.showReFresh"
              inline-prompt
              active-text="开"
              inactive-text="关"
            />
          ...
          <li>
            ...
            <el-switch
              ...
              inactive-color="#A8ABB2"
              v-model="configStore.appConfig.showFoldButton"
              inline-prompt
              active-text="开"
              inactive-text="关"
            />
          ...
          <li>
            ...
            <el-switch
              ...
              inactive-color="#A8ABB2"
              v-model="configStore.appConfig.showI18n"
              inline-prompt
              active-text="开"
              inactive-text="关"
            />
          ...
          <li>
            ...
            <el-switch
              ...
              inactive-color="#A8ABB2"
              v-model="configStore.appConfig.showMessage"
              inline-prompt
              active-text="开"
              inactive-text="关"
            />
          ...
          <li>
            ...
            <el-switch
              ...
              inactive-color="#A8ABB2"
              v-model="configStore.appConfig.showFullScreen"
              inline-prompt
              active-text="开"
              inactive-text="关"
            />
          ...
          <li>
            ...
            <el-switch
              ...
              inactive-color="#A8ABB2"
              v-model="configStore.appConfig.showLogo"
              inline-prompt
              active-text="开"
              inactive-text="关"
            />
        ...
        <ul class="config-list">
          <li>
            ...
            <el-switch
              ...
              inactive-color="#A8ABB2"
              v-model="configStore.appConfig.showTabBar"
              inline-prompt
              active-text="开"
              inactive-text="关"
            />
        ...
        <ul class="config-list">
          <li>
            ...
            <el-radio-group
              ...
              size="default"
              v-bind:model-value="configStore.componentSize"
            >
              <el-radio-button
                :label="item.value"
                v-for="(item, index) in Component_Size"
                :key="index"
              >
          ...
          <li>
            ...
            <el-input-number
              size="default"
              v-model="configStore.KeepAliveMaxLength"
              :min="1"
              :max="10"
              @change="((e: unknown) => {
                                if (typeof e === 'number') {
...
const emits = defineEmits<{
  (e: "update:configVisible", target: boolean): void;
}>();
